...
const (
	...
	WireGuardService_GetPeersPage_FullMethodName   = "/gateway.v2.WireGuardService/GetPeersPage"
	WireGuardService_GetIPPool_FullMethodName      = "/gateway.v2.WireGuardService/GetIPPool"
...
type WireGuardServiceClient interface {
	...
	// peers page
	GetPeersPage(ctx context.Context, in *GetPeersPageRequest, opts ...grpc.CallOption) (*GetPeersPageResponse, error)
	// configured automatic address pool
...
func (c *wireGuardServiceClient) GetPeersPage(ctx context.Context, in *GetPeersPageRequest, opts ...grpc.CallOption) (*GetPeersPageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPeersPageResponse)
	err := c.cc.Invoke(ctx, WireGuardService_GetPeersPage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wireGuardServiceClient) GetIPPool(ctx context.Context, in *GetIPPoolRequest, opts ...grpc.CallOption) (*GetIPPoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetIPPoolResponse)
	err := c.cc.Invoke(ctx, WireGuardService_GetIPPool_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WireGuardServiceServer interface {
	...
	// peers page
	GetPeersPage(context.Context, *GetPeersPageRequest) (*GetPeersPageResponse, error)
	// configured automatic address pool
...
func (UnimplementedWireGuardServiceServer) GetPeerTraffic(context.Context, *GetPeerTrafficRequest) (*GetPeerTrafficResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPeerTraffic not implemented")
}
func (UnimplementedWireGuardServiceServer) GetPeersPage(context.Context, *GetPeersPageRequest) (*GetPeersPageResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPeersPage not implemented")
}
func (UnimplementedWireGuardServiceServer) GetIPPool(context.Context, *GetIPPoolRequest) (*GetIPPoolResponse, error) {
...
func (UnimplementedWireGuardServiceServer) ListPeer(context.Context, *ListPeerRequest) (*ListPeerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListPeer not implemented")
}
...
func RegisterWireGuardServiceServer(s grpc.ServiceRegistrar, srv WireGuardServiceServer) {
	// If the following call panics, it indicates UnimplementedWireGuardServiceServer was
...
func _WireGuardService_GetPeersPage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPeersPageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WireGuardServiceServer).GetPeersPage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WireGuardService_GetPeersPage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WireGuardServiceServer).GetPeersPage(ctx, req.(*GetPeersPageRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _WireGuardService_GetIPPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetIPPoolRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WireGuardServiceServer).GetIPPool(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WireGuardService_GetIPPool_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WireGuardServiceServer).GetIPPool(ctx, req.(*GetIPPoolRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WireGuardService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPeersPage",
			Handler:    _WireGuardService_GetPeersPage_Handler,
		},
		{
			MethodName: "GetIPPool",
			Handler:    _WireGuardService_GetIPPool_Handler,
		},
		{
